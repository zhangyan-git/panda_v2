 ...
 *
 * 原先还有「账户号」与「接收方名」两个标签，现在已经没有了：账户号只是我们自己编的号、它那条
 * 唯一约束护的也只是「别重名」，而当初写着「结算单上写它」的那个用途从来没有兑现（结算单那两
...
export default function SettlementAccountsPage() {
  ...
  const columns: ProColumns<SettlementAccount>[] = [
    ...
    {
      // 主体名是给人认人的，也是这一行**唯一**的名字（账户表上没有账户号那一列）。所以它必填：
    ...
    >
      ...
      */}
      ...
      >
        ...
        />
        {/*
          这里原先还有「关联门店 / 关联品牌 / 关联商户」三个下拉，账户表上已经没有这三列：账户
